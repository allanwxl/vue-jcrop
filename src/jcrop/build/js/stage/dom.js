  ...
  initStageDrag () {
    ...
    Dragger(this.el,
      (x,y,e) => {
        ...
        crop.el.id = 'rect' + this.index;
        let tempNode = document.createElement('div');
        tempNode.style.height = '100%';
        tempNode.style.width = '100%';
        const template = `<div style="height: 100%; width: 100%; display: flex; justify-content: center; align-items: center;"><span style="font-size: xx-large; font-weight: bolder; color: yellow;">${this.index}</span></div>`;
        tempNode.innerHTML = template;
        crop.el.appendChild(tempNode);
        this.index++;
        // console.log(crop);
        this.addWidget(crop);
